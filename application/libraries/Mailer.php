...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'asyhadi@pertanian.go.id'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Asyhadi Laksono Hakim'; // Isikan dengan nama pengirim
    protected $password = 'Alm4hyr4'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->Host = 'mail.pertanian.go.id';
        $mail->Username = 'asyhadi@pertanian.go.id'; // Email Pengirim
        $mail->Password = 'Alm4hyr4'; // Isikan dengan Password email pengirim
        $mail->Port = 587;
        $mail->SMTPAuth = true;
        $mail->SMTPSecure = false;
        //$mail->SMTPDebug = 3; // Aktifkan untuk melakukan debugging
        ...
        $mail->setFrom('asyhadi@pertanian.go.id', 'noreply@pertanian.go.id');
