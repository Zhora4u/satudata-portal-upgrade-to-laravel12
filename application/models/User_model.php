...
class User_model extends CI_model
{
    ...
    */
    var $table = 'tbl_user';
    var $column_order = array(null, 'nama_user', 'nip', 'unitkerja', 'email', 'hp', 'created_at'); //set column field database for datatable orderable
    var $column_search = array('nama_user', 'nip', 'unitkerja', 'email', 'hp', 'created_at'); //set column field database for datatable searchable 
